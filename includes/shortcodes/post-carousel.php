...
function eacs_post_carousel( $atts ) {
  ...
  $class         = ( $class        != ''     ) ? 'eacs-post-carousel swiper-wrapper eacs-post-grid row ' . esc_attr( $class ) : 'eacs-post-carousel swiper-wrapper eacs-post-grid row';
  ...
  $output = "<div {$id} class=\"{$class}{$orientation}\" {$style} {$data} data-fade=\"{$fade}\" >";
    ...
    if ( $q->have_posts() ) : while ( $q->have_posts() ) : $q->the_post();
      ...
      $output .= '<article id="post-' . get_the_ID() . '" class="eacs-grid-post swiper-slide">'
